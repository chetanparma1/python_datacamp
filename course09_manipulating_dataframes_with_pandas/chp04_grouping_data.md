...
## 10. Grouping and filtering with .apply()
...
In [4]: c_surv_by_sex = by_sex.apply(c_deck_survival)
...
## 11. Grouping and filtering with .filter()
...
## 12. Filtering and grouping with .map()
