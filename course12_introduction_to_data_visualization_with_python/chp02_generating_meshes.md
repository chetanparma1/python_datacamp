...
## 10. Rescaling pixel intensities
Sometimes, low contrast images can be improved by rescaling their intensities. For instance, this image of <a href="https://commons.wikimedia.org/wiki/File:Unequalized_Hawkes_Bay_NZ.jpg">Hawkes Bay, New Zealand</a> (originally by Phillip Capper, modified by User:Konstable, via Wikimedia Commons, <a href="http://creativecommons.org/licenses/by/2.0">CC BY 2.0</a>) has no pixel values near 0 or near 255 (the limits of valid intensities).
...
#### Output:
The pixels of the image are lay around the number 140s, 150s, ..., 170s. It caused the image to have a low contrast. 
```
In [5]: image
Out[5]: 
...
```
![Alt text](./rescaled.svg)

#### Comment:
Excellent work! As you can see, the rescaled image has pixel intensities in between 0 and 256.
