...
<br />
**Scatter plot with sns, scatter = True**
![Alt text](./sns_scatter_true.svg)
<br />
**Scatter plot with sns, scatter=None, no prev plt scatter**
![Alt text](./sns_scatter_none_noprevplt.svg)
<br />
**Scatter plot with sns, scatter=None, with prev plt scatter**
![Alt text](./sns_scatter_none_prevplt.svg)
<br />
**Scatter plot with sns, scatter=True, order=2, no prev plt scatter**
![Alt text](./sns_scatter2_noprevplt.svg)
<br />
**Scatter plot with sns, scatter=None, order=2, with prev plt scatter**
![Alt text](./sns_scatter2_none_prevplt.svg)
<br />
**Scatter plot with sns, scatter=True, order=2, no prev plt scatter**
![Alt text](./sns_scatter2_true.svg)
<br />
**Scatter plot with sns, order 1 & 2, scatter=None, with prev plt scatter**
