...
## 08. Updating data sources from dropdown callbacks
...
```
#### Output:
![Alt text](./dropdown.gif)

#### Comment:
Great work! Dropdowns can add a lot of interactivity to figures. In the next exercise, you'll learn how to synchronize two dropdowns.

## 09. Synchronize two dropdowns
