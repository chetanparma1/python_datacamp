...
## 08. Adding dropdowns to the app
...
```
#### Output:
![Alt text](./gapminder_1970_color_hover_dropdown.gif)

#### Comment:
Amazing work! Enjoy interacting with your app! If you cannot see the entire app in your screen, expand it into a new window by clicking the pop-out icon.
